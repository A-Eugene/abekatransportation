...
<div class="jumbotron container-fluid position-relative bg-cover bg-bottom bg-fixed bg-no-repeat">
  <div class="overlay position-absolute top-0 start-0 w-100 h-100"></div>

  <div class="container position-relative text-white text-center d-flex flex-column justify-content-center min-h-100">
